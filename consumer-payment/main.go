...
import (
	...
	"consumer-payment-logs-go/config"
	"consumer-payment-logs-go/package/db"
	"consumer-payment-logs-go/helper/logging"
	"consumer-payment-logs-go/model"
	"consumer-payment-logs-go/repository"
)
...
func main() {
	...
	q, err := ch.QueueDeclare(
		"create_payment_logs",// queue name
		true,                 // durable
	...
	go func() {
		for d := range msgs {
			...
			var data model.PaymentLogRequest
